...
namespace S3 {
namespace Model {
class PutObjectRDMAResult {
 public:
  AWS_S3_API PutObjectRDMAResult() = default;
  AWS_S3_API PutObjectRDMAResult(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  AWS_S3_API PutObjectRDMAResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Xml::XmlDocument>& result);
  ...
  template <typename ExpirationT = Aws::String>
  PutObjectRDMAResult& WithExpiration(ExpirationT&& value) {
  ...
  template <typename ETagT = Aws::String>
  PutObjectRDMAResult& WithETag(ETagT&& value) {
  ...
  template <typename ChecksumCRC32T = Aws::String>
  PutObjectRDMAResult& WithChecksumCRC32(ChecksumCRC32T&& value) {
  ...
  template <typename ChecksumCRC32CT = Aws::String>
  PutObjectRDMAResult& WithChecksumCRC32C(ChecksumCRC32CT&& value) {
  ...
  template <typename ChecksumCRC64NVMET = Aws::String>
  PutObjectRDMAResult& WithChecksumCRC64NVME(ChecksumCRC64NVMET&& value) {
  ...
  template <typename ChecksumSHA1T = Aws::String>
  PutObjectRDMAResult& WithChecksumSHA1(ChecksumSHA1T&& value) {
  ...
  template <typename ChecksumSHA256T = Aws::String>
  PutObjectRDMAResult& WithChecksumSHA256(ChecksumSHA256T&& value) {
  ...
  template <typename ChecksumSHA512T = Aws::String>
  PutObjectRDMAResult& WithChecksumSHA512(ChecksumSHA512T&& value) {
  ...
  template <typename ChecksumMD5T = Aws::String>
  PutObjectRDMAResult& WithChecksumMD5(ChecksumMD5T&& value) {
  ...
  template <typename ChecksumXXHASH64T = Aws::String>
  PutObjectRDMAResult& WithChecksumXXHASH64(ChecksumXXHASH64T&& value) {
  ...
  template <typename ChecksumXXHASH3T = Aws::String>
  PutObjectRDMAResult& WithChecksumXXHASH3(ChecksumXXHASH3T&& value) {
  ...
  template <typename ChecksumXXHASH128T = Aws::String>
  PutObjectRDMAResult& WithChecksumXXHASH128(ChecksumXXHASH128T&& value) {
  ...
  inline PutObjectRDMAResult& WithChecksumType(ChecksumType value) {
  ...
  inline PutObjectRDMAResult& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  template <typename VersionIdT = Aws::String>
  PutObjectRDMAResult& WithVersionId(VersionIdT&& value) {
  ...
  template <typename SSECustomerAlgorithmT = Aws::String>
  PutObjectRDMAResult& WithSSECustomerAlgorithm(SSECustomerAlgorithmT&& value) {
  ...
  template <typename SSECustomerKeyMD5T = Aws::String>
  PutObjectRDMAResult& WithSSECustomerKeyMD5(SSECustomerKeyMD5T&& value) {
  ...
  template <typename SSEKMSKeyIdT = Aws::String>
  PutObjectRDMAResult& WithSSEKMSKeyId(SSEKMSKeyIdT&& value) {
  ...
  template <typename SSEKMSEncryptionContextT = Aws::String>
  PutObjectRDMAResult& WithSSEKMSEncryptionContext(SSEKMSEncryptionContextT&& value) {
  ...
  inline PutObjectRDMAResult& WithBucketKeyEnabled(bool value) {
  ...
  inline PutObjectRDMAResult& WithSize(long long value) {
    SetSize(value);
    return *this;
  }
  ///@}
  ...
  inline PutObjectRDMAResult& WithRequestCharged(RequestCharged value) {
  ...
  inline PutObjectRDMAResult& WithRDMAReply(int value) {
    SetRDMAReply(value);
    return *this;
  }
  ///@}
  ...
  template <typename RequestIdT = Aws::String>
  PutObjectRDMAResult& WithRequestId(RequestIdT&& value) {
