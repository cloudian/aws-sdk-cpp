...
/**
 */
class PutObjectRDMARequest : public S3Request {
 public:
  AWS_S3_API PutObjectRDMARequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "PutObjectRDMA"; }
  ...
  inline PutObjectRDMARequest& WithACL(ObjectCannedACL value) {
    SetACL(value);
    return *this;
  }
  ///@}
  ...
  template <typename BucketT = Aws::String>
  PutObjectRDMARequest& WithBucket(BucketT&& value) {
  ...
  template <typename CacheControlT = Aws::String>
  PutObjectRDMARequest& WithCacheControl(CacheControlT&& value) {
  ...
  template <typename ContentDispositionT = Aws::String>
  PutObjectRDMARequest& WithContentDisposition(ContentDispositionT&& value) {
  ...
  template <typename ContentEncodingT = Aws::String>
  PutObjectRDMARequest& WithContentEncoding(ContentEncodingT&& value) {
  ...
  template <typename ContentLanguageT = Aws::String>
  PutObjectRDMARequest& WithContentLanguage(ContentLanguageT&& value) {
  ...
  inline PutObjectRDMARequest& WithContentLength(long long value) {
  ...
  template <typename ContentMD5T = Aws::String>
  PutObjectRDMARequest& WithContentMD5(ContentMD5T&& value) {
  ...
  ///@{
  /**
   * <p>A standard MIME type describing the format of the contents. For more
   * information, see <a
   * href="https://www.rfc-editor.org/rfc/rfc9110.html#name-content-type">https://www.rfc-editor.org/rfc/rfc9110.html#name-content-type</a>.</p>
   */
  ...
  template <typename ContentTypeT = Aws::String>
  PutObjectRDMARequest& WithContentType(ContentTypeT&& value) {
  ...
  inline PutObjectRDMARequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  template <typename ChecksumCRC32T = Aws::String>
  PutObjectRDMARequest& WithChecksumCRC32(ChecksumCRC32T&& value) {
  ...
  template <typename ChecksumCRC32CT = Aws::String>
  PutObjectRDMARequest& WithChecksumCRC32C(ChecksumCRC32CT&& value) {
  ...
  template <typename ChecksumCRC64NVMET = Aws::String>
  PutObjectRDMARequest& WithChecksumCRC64NVME(ChecksumCRC64NVMET&& value) {
  ...
  template <typename ChecksumSHA1T = Aws::String>
  PutObjectRDMARequest& WithChecksumSHA1(ChecksumSHA1T&& value) {
  ...
  template <typename ChecksumSHA256T = Aws::String>
  PutObjectRDMARequest& WithChecksumSHA256(ChecksumSHA256T&& value) {
  ...
  template <typename ChecksumSHA512T = Aws::String>
  PutObjectRDMARequest& WithChecksumSHA512(ChecksumSHA512T&& value) {
  ...
  template <typename ChecksumMD5T = Aws::String>
  PutObjectRDMARequest& WithChecksumMD5(ChecksumMD5T&& value) {
  ...
  template <typename ChecksumXXHASH64T = Aws::String>
  PutObjectRDMARequest& WithChecksumXXHASH64(ChecksumXXHASH64T&& value) {
  ...
  template <typename ChecksumXXHASH3T = Aws::String>
  PutObjectRDMARequest& WithChecksumXXHASH3(ChecksumXXHASH3T&& value) {
  ...
  template <typename ChecksumXXHASH128T = Aws::String>
  PutObjectRDMARequest& WithChecksumXXHASH128(ChecksumXXHASH128T&& value) {
  ...
  template <typename ExpiresT = Aws::Utils::DateTime>
  PutObjectRDMARequest& WithExpires(ExpiresT&& value) {
  ...
  template <typename IfMatchT = Aws::String>
  PutObjectRDMARequest& WithIfMatch(IfMatchT&& value) {
  ...
  template <typename IfNoneMatchT = Aws::String>
  PutObjectRDMARequest& WithIfNoneMatch(IfNoneMatchT&& value) {
  ...
  template <typename GrantFullControlT = Aws::String>
  PutObjectRDMARequest& WithGrantFullControl(GrantFullControlT&& value) {
  ...
  template <typename GrantReadT = Aws::String>
  PutObjectRDMARequest& WithGrantRead(GrantReadT&& value) {
  ...
  template <typename GrantReadACPT = Aws::String>
  PutObjectRDMARequest& WithGrantReadACP(GrantReadACPT&& value) {
  ...
  template <typename GrantWriteACPT = Aws::String>
  PutObjectRDMARequest& WithGrantWriteACP(GrantWriteACPT&& value) {
  ...
  template <typename KeyT = Aws::String>
  PutObjectRDMARequest& WithKey(KeyT&& value) {
  ...
  inline PutObjectRDMARequest& WithWriteOffsetBytes(long long value) {
  ...
  template <typename MetadataT = Aws::Map<Aws::String, Aws::String>>
  PutObjectRDMARequest& WithMetadata(MetadataT&& value) {
    SetMetadata(std::forward<MetadataT>(value));
    return *this;
  }
  template <typename MetadataKeyT = Aws::String, typename MetadataValueT = Aws::String>
  PutObjectRDMARequest& AddMetadata(MetadataKeyT&& key, MetadataValueT&& value) {
    m_metadataHasBeenSet = true;
  ...
  inline PutObjectRDMARequest& WithServerSideEncryption(ServerSideEncryption value) {
  ...
  inline PutObjectRDMARequest& WithStorageClass(StorageClass value) {
  ...
  template <typename WebsiteRedirectLocationT = Aws::String>
  PutObjectRDMARequest& WithWebsiteRedirectLocation(WebsiteRedirectLocationT&& value) {
  ...
  template <typename SSECustomerAlgorithmT = Aws::String>
  PutObjectRDMARequest& WithSSECustomerAlgorithm(SSECustomerAlgorithmT&& value) {
  ...
  template <typename SSECustomerKeyT = Aws::String>
  PutObjectRDMARequest& WithSSECustomerKey(SSECustomerKeyT&& value) {
  ...
  template <typename SSECustomerKeyMD5T = Aws::String>
  PutObjectRDMARequest& WithSSECustomerKeyMD5(SSECustomerKeyMD5T&& value) {
  ...
  template <typename SSEKMSKeyIdT = Aws::String>
  PutObjectRDMARequest& WithSSEKMSKeyId(SSEKMSKeyIdT&& value) {
  ...
  template <typename SSEKMSEncryptionContextT = Aws::String>
  PutObjectRDMARequest& WithSSEKMSEncryptionContext(SSEKMSEncryptionContextT&& value) {
  ...
  inline PutObjectRDMARequest& WithBucketKeyEnabled(bool value) {
  ...
  inline PutObjectRDMARequest& WithRequestPayer(RequestPayer value) {
  ...
  template <typename TaggingT = Aws::String>
  PutObjectRDMARequest& WithTagging(TaggingT&& value) {
  ...
  inline PutObjectRDMARequest& WithObjectLockMode(ObjectLockMode value) {
  ...
  template <typename ObjectLockRetainUntilDateT = Aws::Utils::DateTime>
  PutObjectRDMARequest& WithObjectLockRetainUntilDate(ObjectLockRetainUntilDateT&& value) {
  ...
  inline PutObjectRDMARequest& WithObjectLockLegalHoldStatus(ObjectLockLegalHoldStatus value) {
  ...
  inline PutObjectRDMARequest& WithObjectLockEventHold(ObjectLockEventHold value) {
  ...
  inline PutObjectRDMARequest& WithObjectLockEventHoldDurationDays(int value) {
  ...
  inline PutObjectRDMARequest& WithObjectLockEventHoldDurationYears(int value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  PutObjectRDMARequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename RDMATokenT = Aws::String>
  PutObjectRDMARequest& WithRDMAToken(RDMATokenT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  PutObjectRDMARequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  PutObjectRDMARequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key, CustomizedAccessLogTagValueT&& value) {
    m_customizedAccessLogTagHasBeenSet = true;
