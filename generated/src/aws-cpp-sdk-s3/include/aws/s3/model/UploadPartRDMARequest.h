...
/**
 */
class UploadPartRDMARequest : public S3Request {
 public:
  AWS_S3_API UploadPartRDMARequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "UploadPartRDMA"; }
  ...
  template <typename BucketT = Aws::String>
  UploadPartRDMARequest& WithBucket(BucketT&& value) {
  ...
  inline UploadPartRDMARequest& WithContentLength(long long value) {
  ...
  template <typename ContentMD5T = Aws::String>
  UploadPartRDMARequest& WithContentMD5(ContentMD5T&& value) {
  ...
  inline UploadPartRDMARequest& WithChecksumAlgorithm(ChecksumAlgorithm value) {
  ...
  template <typename ChecksumCRC32T = Aws::String>
  UploadPartRDMARequest& WithChecksumCRC32(ChecksumCRC32T&& value) {
  ...
  template <typename ChecksumCRC32CT = Aws::String>
  UploadPartRDMARequest& WithChecksumCRC32C(ChecksumCRC32CT&& value) {
  ...
  template <typename ChecksumCRC64NVMET = Aws::String>
  UploadPartRDMARequest& WithChecksumCRC64NVME(ChecksumCRC64NVMET&& value) {
  ...
  template <typename ChecksumSHA1T = Aws::String>
  UploadPartRDMARequest& WithChecksumSHA1(ChecksumSHA1T&& value) {
  ...
  template <typename ChecksumSHA256T = Aws::String>
  UploadPartRDMARequest& WithChecksumSHA256(ChecksumSHA256T&& value) {
  ...
  template <typename ChecksumSHA512T = Aws::String>
  UploadPartRDMARequest& WithChecksumSHA512(ChecksumSHA512T&& value) {
  ...
  template <typename ChecksumMD5T = Aws::String>
  UploadPartRDMARequest& WithChecksumMD5(ChecksumMD5T&& value) {
  ...
  template <typename ChecksumXXHASH64T = Aws::String>
  UploadPartRDMARequest& WithChecksumXXHASH64(ChecksumXXHASH64T&& value) {
  ...
  template <typename ChecksumXXHASH3T = Aws::String>
  UploadPartRDMARequest& WithChecksumXXHASH3(ChecksumXXHASH3T&& value) {
  ...
  template <typename ChecksumXXHASH128T = Aws::String>
  UploadPartRDMARequest& WithChecksumXXHASH128(ChecksumXXHASH128T&& value) {
  ...
  template <typename KeyT = Aws::String>
  UploadPartRDMARequest& WithKey(KeyT&& value) {
  ...
  inline UploadPartRDMARequest& WithPartNumber(int value) {
    SetPartNumber(value);
    return *this;
  }
  ///@}
  ...
  template <typename UploadIdT = Aws::String>
  UploadPartRDMARequest& WithUploadId(UploadIdT&& value) {
  ...
  template <typename SSECustomerAlgorithmT = Aws::String>
  UploadPartRDMARequest& WithSSECustomerAlgorithm(SSECustomerAlgorithmT&& value) {
  ...
  template <typename SSECustomerKeyT = Aws::String>
  UploadPartRDMARequest& WithSSECustomerKey(SSECustomerKeyT&& value) {
  ...
  template <typename SSECustomerKeyMD5T = Aws::String>
  UploadPartRDMARequest& WithSSECustomerKeyMD5(SSECustomerKeyMD5T&& value) {
  ...
  inline UploadPartRDMARequest& WithRequestPayer(RequestPayer value) {
  ...
  template <typename ExpectedBucketOwnerT = Aws::String>
  UploadPartRDMARequest& WithExpectedBucketOwner(ExpectedBucketOwnerT&& value) {
  ...
  template <typename RDMATokenT = Aws::String>
  UploadPartRDMARequest& WithRDMAToken(RDMATokenT&& value) {
  ...
  template <typename CustomizedAccessLogTagT = Aws::Map<Aws::String, Aws::String>>
  UploadPartRDMARequest& WithCustomizedAccessLogTag(CustomizedAccessLogTagT&& value) {
  ...
  UploadPartRDMARequest& AddCustomizedAccessLogTag(CustomizedAccessLogTagKeyT&& key, CustomizedAccessLogTagValueT&& value) {
    m_customizedAccessLogTagHasBeenSet = true;
