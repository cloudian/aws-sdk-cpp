...
class AWS_S3_API S3Client : public Aws::Client::AWSXMLClient,
                            public Aws::Client::ClientWithAsyncTemplateMethods<S3Client>, public Aws::S3::S3ClientRDMA,
                            public S3PaginationBase<S3Client>,
                            public S3Waiter<S3Client> {
 public:
    using Aws::S3::S3ClientRDMA::GetObjectRDMA;
    using Aws::S3::S3ClientRDMA::GetObjectRDMAAsync;
    using Aws::S3::S3ClientRDMA::GetObjectRDMAPtrCallable;
    using Aws::S3::S3ClientRDMA::PutObjectRDMA;
    using Aws::S3::S3ClientRDMA::PutObjectRDMAAsync;
    using Aws::S3::S3ClientRDMA::PutObjectRDMAPtrCallable;
    using Aws::S3::S3ClientRDMA::UploadPartRDMA;
    using Aws::S3::S3ClientRDMA::UploadPartRDMAAsync;
    using Aws::S3::S3ClientRDMA::UploadPartRDMAPtrCallable;
   ...
   * Reference</a></p>
   */
  virtual Model::GetObjectOutcome GetObjectTCP(const Model::GetObjectRequest& request) const;
   ...
   */
  virtual Model::GetObjectOutcomeCallable GetObjectTCPCallable(const Model::GetObjectRequest& request) const;
   ...
   * finished.
   */
  virtual void GetObjectTCPAsync(const Model::GetObjectRequest& request, const GetObjectResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const;
   ...
   * Reference</a></p>
   */
  virtual Model::PutObjectOutcome PutObjectTCP(const Model::PutObjectRequest& request) const;
   ...
   */
  virtual Model::PutObjectOutcomeCallable PutObjectTCPCallable(const Model::PutObjectRequest& request) const;
   ...
   * finished.
   */
  virtual void PutObjectTCPAsync(const Model::PutObjectRequest& request, const PutObjectResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const;
   ...
   * encode this value to <code>my%20%20file.txt</code>.</p> <p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/s3-2006-03-01/PutObjectRDMA">AWS
   * API Reference</a></p>
   */
  virtual Model::PutObjectRDMAOutcome PutObjectRDMA(const Model::PutObjectRDMARequest& request) const;
   ...
   */
  template <typename PutObjectRDMARequestT = Model::PutObjectRDMARequest>
  Model::PutObjectRDMAOutcomeCallable PutObjectRDMACallable(const PutObjectRDMARequestT& request) const {
    return SubmitCallable(&S3Client::PutObjectRDMA, request);
  }

  /**
   * An Async wrapper for PutObjectRDMA that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename PutObjectRDMARequestT = Model::PutObjectRDMARequest>
  void PutObjectRDMAAsync(const PutObjectRDMARequestT& request, const PutObjectRDMAResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::PutObjectRDMA, request, handler, context);
  }
   ...
   * Reference</a></p>
   */
  virtual Model::UploadPartOutcome UploadPartTCP(const Model::UploadPartRequest& request) const;
  ...
  Model::UploadPartOutcomeCallable UploadPartTCPCallable(const UploadPartRequestT& request) const {
   ...
   */
  template <typename UploadPartRequestT = Model::UploadPartRequest>
  void UploadPartTCPAsync(const UploadPartRequestT& request, const UploadPartResponseReceivedHandler& handler,
                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * encode this value to <code>my%20%20file.txt</code>.</p> <p><h3>See
   * Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/s3-2006-03-01/UploadPartRDMA">AWS
   * API Reference</a></p>
   */
  virtual Model::UploadPartRDMAOutcome UploadPartRDMA(const Model::UploadPartRDMARequest& request) const;
   ...
   */
  template <typename UploadPartRDMARequestT = Model::UploadPartRDMARequest>
  Model::UploadPartRDMAOutcomeCallable UploadPartRDMACallable(const UploadPartRDMARequestT& request) const {
    return SubmitCallable(&S3Client::UploadPartRDMA, request);
  }

  /**
   * An Async wrapper for UploadPartRDMA that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UploadPartRDMARequestT = Model::UploadPartRDMARequest>
  void UploadPartRDMAAsync(const UploadPartRDMARequestT& request, const UploadPartRDMAResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
    return SubmitAsync(&S3Client::UploadPartRDMA, request, handler, context);
  }
 ...
 private:
        friend class Aws::S3::S3ClientRDMA;
