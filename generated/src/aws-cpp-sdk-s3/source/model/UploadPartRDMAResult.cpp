...
UploadPartRDMAResult::UploadPartRDMAResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }

UploadPartRDMAResult& UploadPartRDMAResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
