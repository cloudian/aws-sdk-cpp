...
Aws::String PutObjectRDMARequest::SerializePayload() const { return {}; }

void PutObjectRDMARequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
...
Aws::Http::HeaderValueCollection PutObjectRDMARequest::GetRequestSpecificHeaders() const {
...
PutObjectRDMARequest::EndpointParameters PutObjectRDMARequest::GetEndpointContextParams() const {
