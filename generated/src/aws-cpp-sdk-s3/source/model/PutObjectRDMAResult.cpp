...
PutObjectRDMAResult::PutObjectRDMAResult(const Aws::AmazonWebServiceResult<XmlDocument>& result) { *this = result; }

PutObjectRDMAResult& PutObjectRDMAResult::operator=(const Aws::AmazonWebServiceResult<XmlDocument>& result) {
