...
Aws::String UploadPartRDMARequest::SerializePayload() const { return {}; }

void UploadPartRDMARequest::AddQueryStringParameters(URI& uri) const {
  Aws::StringStream ss;
...
Aws::Http::HeaderValueCollection UploadPartRDMARequest::GetRequestSpecificHeaders() const {
...
UploadPartRDMARequest::EndpointParameters UploadPartRDMARequest::GetEndpointContextParams() const {
